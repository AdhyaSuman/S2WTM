...
path_to_mallet_binary = "/home/suman/SMN/SWVITM/mallet-2.0.8/mallet-2.0.8/bin/mallet"  # Full path"

class LDAMallet(AbstractModel):
    ...
    def __init__(
        self, num_topics=100, random_seed=0, use_partitions=True):
        """
        Initialize LDAMallet model
    ...
    def info(self):
        ...
        return {
            ...
            "name": "LDA-Mallet, Latent Dirichlet Allocation"
        }
    ...
    def train_model(self, dataset, hyperparams=None, top_words=10):
        ...
        self.trained_model = LdaMallet(mallet_path=path_to_mallet_binary, iterations=100, **self.hyperparameters)
